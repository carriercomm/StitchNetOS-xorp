...
#include "fea_data_plane_manager_stitch.hh"
#include "fea/data_plane/ifconfig/ifconfig_set_stitch.hh"
...
FeaDataPlaneManagerStitch::FeaDataPlaneManagerStitch(FeaNode& fea_node, XrlRouter& xrl_router)
    : FeaDataPlaneManager(fea_node, "FeaStitch", xrl_router),
    _stitch_lc_fea(&xrl_router)
{
}

int
FeaDataPlaneManagerStitch::load_plugins(string& error_msg)
{
    UNUSED(error_msg);
    ...
    // Load the plugins
    //
    _ifconfig_set = new IfConfigSetStitch(*this);



//////////////////////////////////////////////////////
//Simranjit: Borrowing plugins from linux dp manager
...
int
FeaDataPlaneManagerStitch::unload_plugins(string& error_msg)
{
    if (! _is_loaded_plugins)
	return (XORP_OK);
...
int
FeaDataPlaneManagerStitch::register_plugins(string& error_msg)
{
    return (FeaDataPlaneManager::register_all_plugins(true, error_msg));
}

IoLink*
FeaDataPlaneManagerStitch::allocate_io_link(const IfTree& iftree,
...
IoIp*
FeaDataPlaneManagerStitch::allocate_io_ip(const IfTree& iftree, int family,
					 uint8_t ip_protocol)
{
    IoIp* io_ip = NULL;
...
IoTcpUdp*
FeaDataPlaneManagerStitch::allocate_io_tcpudp(const IfTree& iftree, int family,
					     bool is_tcp)
{
