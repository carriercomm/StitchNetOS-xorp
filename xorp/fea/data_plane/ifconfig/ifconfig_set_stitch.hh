...
// $XORP: xorp/fea/data_plane/ifconfig/ifconfig_set_stitch.hh,v 1.14 2014/08/14 22:40:00 Exp $

#ifndef __FEA_DATA_PLANE_IFCONFIG_IFCONFIG_SET_STITCH_HH__
#define __FEA_DATA_PLANE_IFCONFIG_IFCONFIG_SET_STITCH_HH__
...
class IfConfigSetStitch : public IfConfigSet
				 {
public:
     ...
     */
    IfConfigSetStitch(FeaDataPlaneManager& fea_data_plane_manager);

    /**
     * Virtual destructor.
     */
    virtual ~IfConfigSetStitch();
...
private:
	...
	void add_addr_cb(const XrlError& xrl_error, const string* err_msg);
...
#endif // __FEA_DATA_PLANE_IFCONFIG_IFCONFIG_SET_STITCH_HH__
